...
// (Supplements tab removed — folded into the unified Health History tab.
//  Supplements are now displayed read-only in `_HATab` from
//  `patient.currentMedications` so all medical-history data lives in one
//  place. Editing supplements happens via the Patient Form screen.)
