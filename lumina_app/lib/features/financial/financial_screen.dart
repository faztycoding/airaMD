                      ...
                      child: AiraTapEffect(
                        onTap: () async {
                          ...
                          try {
                            ...
                            if (context.mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('บันทึกสำเร็จ'), backgroundColor: AiraColors.sage),
                              );
                            }
                          } catch (e) {
                            if (context.mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(content: Text('ผิดพลาด: $e'), backgroundColor: AiraColors.terra),
                              );
                            }
                          }
                        },
                        child: Container(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            const SizedBox(width: 8),
                            Text('บันทึก', style: GoogleFonts.plusJakartaSans(fontSize: 14, fontWeight: FontWeight.w700, color: Colors.white)),
                          ]),
                        ),
                      ),
                    ),
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text('ไม่มีรายการ', style: GoogleFonts.plusJakartaSans(fontSize: 15, color: AiraColors.muted)),
              ],
            ),
          );
        }
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text('ไม่มียอดค้างชำระ', style: GoogleFonts.plusJakartaSans(fontSize: 15, color: AiraColors.muted)),
              ],
            ),
          );
        }
